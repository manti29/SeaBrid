    ...
    !function (a) {
        ...
        var O = function () {
            ...
            if (!d) {
                ...
                var g = F(a.location.host, N), h = x(f), i = N.moviePath + w(N.moviePath, N), j = '';
            }
            b = document["global-zeroclipboard-flash-bridge"], b && (c = b.length) && (b = b[c - 1]), e.bridge = b
        }, P = function (a) {
 ...
 */
    !function (a) {
        ...
        a(function () {
            ...
            }), ZeroClipboard.config({moviePath: "", hoverClass: "btn-clipboard-hover"}), a(".highlight").each(function () {
